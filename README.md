...
4. **Set Database Connection:**
   ...
   Contoh: Jika Anda membuat database dbmovie, maka di file `.env` ubahlah `DB_DATABASE=laravel` menjadi `DB_DATABASE=movie`
...
_Credit by: Kevin Ilham Syahreza AkA, ReZy_
